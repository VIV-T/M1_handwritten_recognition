...
DATA_DIR = os.path.join(BASE_DIR, "features_HU")

X = np.load(os.path.join(DATA_DIR, "features_HU.npy"))
y = np.load(os.path.join(DATA_DIR, "labels_HU.npy"), allow_pickle=True)
