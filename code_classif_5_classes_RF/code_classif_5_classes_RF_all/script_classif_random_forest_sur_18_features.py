...
DATA_DIR = os.path.join(BASE_DIR, "features_all")

X = np.load(os.path.join(DATA_DIR, "features_all.npy"))
y = np.load(os.path.join(DATA_DIR, "labels_all.npy"), allow_pickle=True)
