...
DATA_DIR = os.path.join(BASE_DIR, "features_HOG")

X = np.load(os.path.join(DATA_DIR, "features_HOG.npy"))
y = np.load(os.path.join(DATA_DIR, "labels_HOG.npy"), allow_pickle=True)
